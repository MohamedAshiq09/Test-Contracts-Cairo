#[cfg(test)]
mod tests {
    use super::AnonymousNFT;
    use AnonymousNFT::AnonymousNFT::{IZKVerifierDispatcher, IZKVerifierDispatcherTrait, IZKVerifier}; // Import the IZKVerifier trait
    ...
    fn test_mint_anonymous() {
        ...
        AnonymousNFT::AnonymousNFT::IZKVerifierDispatcherTrait::mint_anonymous(anonymous_nft_dispatcher, commitment, proof);
    ...
    fn test_transfer_anonymous() {
        ...
        start_cheat_caller_address(anonymous_nft_address, admin);
        AnonymousNFT::AnonymousNFT::IZKVerifierDispatcherTrait::transfer_anonymous(anonymous_nft_dispatcher, commitment, new_owner, ownership_proof);
        stop_cheat_caller_address(anonymous_nft_address);
    ...
    fn test_burn_anonymous() {
        ...
        start_cheat_caller_address(anonymous_nft_address, admin);
        AnonymousNFT::AnonymousNFT::IZKVerifierDispatcherTrait::burn_anonymous(anonymous_nft_dispatcher, commitment, ownership_proof);
        stop_cheat_caller_address(anonymous_nft_address);
    ...
    fn test_set_admin() {
        ...
        start_cheat_caller_address(anonymous_nft_address, admin);
        AnonymousNFT::AnonymousNFT::IZKVerifierDispatcherTrait::set_admin(anonymous_nft_dispatcher, new_admin);
        stop_cheat_caller_address(anonymous_nft_address);
    ...
    fn test_set_verifier() {
        ...
        start_cheat_caller_address(anonymous_nft_address, admin);
        AnonymousNFT::AnonymousNFT::IZKVerifierDispatcherTrait::set_verifier(anonymous_nft_dispatcher, new_verifier);
        stop_cheat_caller_address(anonymous_nft_address);
